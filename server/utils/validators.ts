...
export function chapterCommentWhere(chapterId: number) {
  return {
    chapterId,
    parentId: null,
    paragraph: null
...
export function paragraphCommentWhere(chapterId: number, paragraph?: number) {
  return {
    chapterId,
    parentId: null,
    paragraph: paragraph !== undefined ? paragraph : { not: null }
  }
}
